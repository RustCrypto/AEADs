...
const CTXISH_TEST_VECTORS: &[TestVector] = &[TestVector {
    key: KEY,
    nonce: &[
    ...
    tag: &hex!("1AE10B594F09E26A7E902ECBD0600691"
            "AAB1642E12099EE049E8E0C3B25944D4DE3AA85428DE5E3CBB97D571B9FC7073"),
}];

tests_with_inplace!(CtxishHmacAead<ChaCha20Poly1305, Sha256>, CTXISH_TEST_VECTORS);
